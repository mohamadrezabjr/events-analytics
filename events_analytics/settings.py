"""
Django settings for events_analytics project.
...
SECRET_KEY = 'django-insecure-5$%xnj@bljy+@ib)k@3hzy62%!2%y!h%gcd8duy%3rlfhr-25c'
...
ROOT_URLCONF = 'events_analytics.urls'
...
WSGI_APPLICATION = 'events_analytics.wsgi.application'
...
CACHES = {
    "default": {
        ...
        "LOCATION": f'redis://{str(os.getenv('REDIS_HOST', 'localhost'))}:6379/1',
        "OPTIONS": {
